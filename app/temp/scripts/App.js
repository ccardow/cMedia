...
var _AnimateOnScroll = __webpack_require__(5);
...
new _AnimateOnScroll2.default((0, _jquery2.default)(".skillBar"), "85%");
...
var MobileMenu = function () {
  function MobileMenu() {
    ...
    this.menuLogo = (0, _jquery2.default)(".header__logo");
    this.events();
  }
...
var AnimateOnScroll = function () {
  function AnimateOnScroll(els, offset) {
      ...
      this.itemsToReveal.each(function () {
        ...
        new Waypoint({
          ...
          handler: function handler() {
            ...
            (0, _jquery2.default)(currentItem).addClass("skillBarValue--is-visible");
          },
          offset: that.offsetPercentage
        });
      });
...
var Modal = function () {
  function Modal() {
    ...
    this.closeModalButton = (0, _jquery2.default)(".close-x");
    this.events();
  }
